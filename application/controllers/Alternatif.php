...
class Alternatif extends CI_Controller
{
    ...
    function index()
    {
		...
		$config['total_rows'] = $this->mod_alternatif->total_rows($q);
     	...
     	$sql="SELECT alternatif.id_alternatif,pembeli.id_pembeli,pembeli.nama_pembeli,pembeli.pekerjaan,pembeli.penghasilan,pembeli.riwayat_kredit,pembeli.usia FROM alternatif LEFT JOIN pembeli ON alternatif.id_pembeli = pembeli.id_pembeli ";
