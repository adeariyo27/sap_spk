...
class Auth extends CI_Controller {
	...
	public function activate($id = NULL)
	{
		...
		$this->form_validation->set_rules('confirm', $this->lang->line('activate_validation_confirm_label'), 'required');
		$this->form_validation->set_rules('id', $this->lang->line('activate_validation_user_id_label'), 'required|alpha_numeric');
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->session->set_flashdata('message', $this->ion_auth->errors());
			$this->template->load('template/backend/dashboard', 'auth/activate_user', $this->data);
			//$this->_render_page('auth/activate_user', $this->data);
		}
		else
		{
	...
	public function edit_user($id)
	{
		...
		$this->form_validation->set_rules('phone', $this->lang->line('edit_user_validation_phone_label'), 'required|numeric');
	...
	public function read_group()
	{
		...
		else
		{
			...
			$this->template->load('template/backend/dashboard', 'auth/read_group', $this->data);
			//$this->_render_page('auth/index', $this->data);
		}
	}
	...
	public function delete_group()
	{
		...
		$this->m->delete_group($id);
		$this->session->set_flashdata('sukses', 'User Level Telah Dihapus');
